...
void main() {
  group('SmartResultCard', () {
    ...
    testWidgets(
      ...
      // Find the GestureDetector widgets that wrap the _MetaToggleChip
      Finder findMetaToggle(String label) {
      ...
      expect(findMetaToggle('位置'), findsOneWidget);
      expect(findMetaToggle('天气'), findsOneWidget);

      await tester.tap(findMetaToggle('天气'));
      await tester.pump();

      await tester.tap(findMetaToggle('位置'));
