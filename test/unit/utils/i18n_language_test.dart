...
void main() {
  group('I18nLanguage', () {
    ...
    group('appLanguageOrSystem', () {
      ...
      test('should fallback to system locale if provided localeCode is empty whitespace', () {
    ...
    group('buildAcceptLanguage', () {
      ...
      test('should handle unsupported languages gracefully by using them as primary', () {
