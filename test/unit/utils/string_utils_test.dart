  ...
  group('StringUtils', () {
    ...
    group('removeObjectReplacementChar', () {
      test('should remove U+FFFC characters from string', () {
        expect(
          StringUtils.removeObjectReplacementChar('Hello\u{FFFC}World'),
          'HelloWorld',
        );
        expect(
          StringUtils.removeObjectReplacementChar('\u{FFFC}Start'),
          'Start',
        );
      ...
      test('should return same string if no U+FFFC is present', () {
        expect(
          StringUtils.removeObjectReplacementChar('Normal String'),
          'Normal String',
        );
