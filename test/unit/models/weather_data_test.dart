...
void main() {
  group('WeatherCodeMapper.getKeyByDescription', () {
    test('returns correct key for known description', () {
      ...
      expect(
        WeatherCodeMapper.getKeyByDescription('partly_cloudy'),
        'partly_cloudy',
      );
      expect(
        WeatherCodeMapper.getKeyByDescription('thunderstorm_heavy'),
        'thunderstorm_heavy',
      );
    });
    ...
    test('returns null for unknown description', () {
      expect(
        WeatherCodeMapper.getKeyByDescription('unknown_description'),
        isNull,
      );
