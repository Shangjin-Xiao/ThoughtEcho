...
void main() {
  group('NoteCategory Model Tests', () {
    ...
    test('should create validated instance', () {
      ...
      // 测试无效数据
      expect(
        () => NoteCategory.validated(id: '', name: '测试'),
        throwsA(isA<ArgumentError>()),
      );
      expect(
        () => NoteCategory.validated(id: 'test', name: ''),
        throwsA(isA<ArgumentError>()),
      );
      expect(
        () => NoteCategory.validated(id: 'test', name: 'a' * 51),
        throwsA(isA<ArgumentError>()),
      );
    });
    ...
    test('should handle edge cases in fromMap', () {
      ...
      expect(
        () => NoteCategory.fromMap({'id': ''}),
        throwsA(isA<ArgumentError>()),
      );
      expect(
        () => NoteCategory.fromMap({'id': 'test', 'name': ''}),
        throwsA(isA<ArgumentError>()),
      );
