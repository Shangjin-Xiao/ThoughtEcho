...
亮暗都给全，接手时直接用。02 来自官网 `res/style.css`，03 是为避开暖调而专门配的。
...
| 强调容器 | `#efe4d6` | `#423931` |
| 强调容器上的文字 | `#6b4f32` | `#e0c9ae` |
| 辅助色 2 / 3 | `#d4895b` / `#7ca982` | 同亮色 |
...
| 强调容器 | `#e3eae9` | `#26302f` |
| 强调容器上的文字 | `#2c4442` | `#b3d1cd` |
| 辅助色 2 / 3 | `#6e7d8a` / `#8a8471` | `#9aa8b4` / `#b0a98f` |

**每套色板落地前必须验证对比度**：正文墨色 / 背景、次要墨色 / 背景、强调上的文字 / 强调，
至少满足 WCAG AA（正文 4.5:1，大字 3:1）。上表是按视觉调的，没有逐对验算过。参考项目
