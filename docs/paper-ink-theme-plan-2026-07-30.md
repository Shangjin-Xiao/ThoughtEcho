# 纸墨主题（Paper & Ink）落地计划 [已归档 / 方案原案]

> [!WARNING]
> ### 📦 本文档已归档 / 方案原案 (Archived / Original Proposal)
> - **归档原因**：本文档为纸墨主题初期设计方案草案与色板选型推导，包含已否决的早期设想（如绕开 FlexColorScheme 手搭 ThemeData、便签纸色等）。
> - **归档时间**：2026-07-31
> - **当前生效事实源**：[`docs/paper-ink-theme-handoff-2026-07-31.md`](paper-ink-theme-handoff-2026-07-31.md)
> - **保留目的**：本文仅供历史方案演进追溯、色板沿革与架构决策背景参考，**禁止直接作为当前代码实现的约束依据**。
