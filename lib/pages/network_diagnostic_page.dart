      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(l10n.httpServerPort(defaultPort.toString())),
            Text(l10n.multicastDiscoveryPort(defaultMulticastPort.toString())),
            Text(l10n.multicastAddress(defaultMulticastGroup)),
            Text(l10n.protocolVersion(protocolVersion)),
          ],
        ),
      ),
    );
