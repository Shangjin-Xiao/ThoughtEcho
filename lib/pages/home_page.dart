...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _initLocationAndWeather() async {
    ...
    } else if (mounted) { // 修复 BuildContext 跨异步使用问题
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (granted && mounted) { // 修复 BuildContext 跨异步使用问题
                _initLocationAndWeather();
              }
            },
          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                ...
                showDialog(
                  context: context,
                  builder: (dialogContext) => AlertDialog( // 使用新的 BuildContext 避免使用旧的跨异步上下文
                    title: const Text('回答'),
                    content: Text(answer),
                    actions: [
                      TextButton(
    ...
    return Scaffold(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        color: Theme.of(context).colorScheme.onPrimaryContainer.withAlpha(128), // 替换 withOpacity
                      ),
                    ),
                    const SizedBox(width: 4),
                    Icon(
      ...
      body: IndexedStack(
        ...
        children: [
          // 首页 - 每日一言
          DailyQuoteView(
            onAddQuote: (content, author, work) => _showAddQuoteDialog(
