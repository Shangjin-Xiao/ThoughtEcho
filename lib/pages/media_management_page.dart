      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatRow(
              l10n.referencedFiles,
              '${stats['referencedFiles'] ?? 0}',
            ),
            _buildStatRow(l10n.orphanFiles, '${stats['orphanFiles'] ?? 0}'),
            _buildStatRow(
              l10n.totalReferences,
            ...
            _buildStatRow(
              l10n.tempFilesCount,
              '${tempStats['totalFiles'] ?? 0}',
            ),
            _buildStatRow(
              l10n.expiredFilesCount,
              '${tempStats['expiredFiles'] ?? 0}',
            ),
            _buildStatRow(
              l10n.tempFilesSize,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildActionButton(
              ...
              () => _performOperation(l10n.cleanupExpiredTempFiles, () async {
                final count =
            ...
            _buildActionButton(
              ...
              Icons.delete_sweep,
              () => _performOperation(l10n.cleanupOrphanFiles, () async {
