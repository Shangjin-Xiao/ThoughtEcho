...
class LWWUtils {
  ...
  /// - 负数：local 更新  
  /// - 0：时间戳相同
  static int compareTimestamps(String? localTimestamp, String? remoteTimestamp) {
  ...
  /// 计算时间戳之间的差值（秒）
  static int getTimestampDifferenceSeconds(String? timestamp1, String? timestamp2) {
...
class LWWDecisionMaker {
  ...
  static LWWMergeDecision makeDecision({
    ...
    // 比较时间戳
    final comparison = LWWUtils.compareTimestamps(localTimestamp, remoteTimestamp);
