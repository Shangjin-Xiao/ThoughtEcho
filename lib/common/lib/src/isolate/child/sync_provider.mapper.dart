...
class SyncStateMapper extends ClassMapperBase<SyncState> {
  ...
  static const Field<SyncState, Function> _f$init =
      Field('init', _$init, arg: _arg$init);
  static Object _$rootIsolateToken(SyncState v) => v.rootIsolateToken;
  static const Field<SyncState, Object> _f$rootIsolateToken =
      Field('rootIsolateToken', _$rootIsolateToken);
  ...
  static dynamic _arg$httpClientFactory(f) =>
      f<InvalidType Function(Duration, InvalidType)>();
  static const Field<SyncState, Function> _f$httpClientFactory = Field(
      'httpClientFactory', _$httpClientFactory,
      arg: _arg$httpClientFactory);
  static InvalidType _$securityContext(SyncState v) => v.securityContext;
  static const Field<SyncState, InvalidType> _f$securityContext =
      Field('securityContext', _$securityContext);
  static InvalidType _$deviceInfo(SyncState v) => v.deviceInfo;
  static const Field<SyncState, InvalidType> _f$deviceInfo =
  ...
  static SyncState fromMap(Map<String, dynamic> map) {
...
mixin SyncStateMappable {
  String toJson() {
    return SyncStateMapper.ensureInitialized()
        .encodeJson<SyncState>(this as SyncState);
  }

  Map<String, dynamic> toMap() {
    return SyncStateMapper.ensureInitialized()
        .encodeMap<SyncState>(this as SyncState);
  }
  ...
  String toString() {
    return SyncStateMapper.ensureInitialized()
        .stringifyValue(this as SyncState);
  }

  @override
  bool operator ==(Object other) {
    return SyncStateMapper.ensureInitialized()
        .equalsValue(this as SyncState, other);
  }
...
abstract class SyncStateCopyWith<$R, $In extends SyncState, $Out>
  ...
  $R call(
      ...
      InvalidType Function(Duration, InvalidType)? httpClientFactory,
      InvalidType? securityContext,
      InvalidType? deviceInfo,
      String? alias,
      int? port,
      List<String>? networkWhitelist,
      List<String>? networkBlacklist,
      InvalidType? protocol,
...
class _SyncStateCopyWithImpl<$R, $Out>
  ...
  SyncState $make(CopyWithData data) => SyncState(
      ...
      rootIsolateToken:
          data.get(#rootIsolateToken, or: $value.rootIsolateToken),
      httpClientFactory:
          data.get(#httpClientFactory, or: $value.httpClientFactory),
