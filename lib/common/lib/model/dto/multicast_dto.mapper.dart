...
class MulticastDtoMapper extends ClassMapperBase<MulticastDto> {
  ...
  static InvalidType _$deviceType(MulticastDto v) => v.deviceType;
  static const Field<MulticastDto, InvalidType> _f$deviceType =
  ...
  static MulticastDto fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<MulticastDto>(map);
  }

  static MulticastDto fromJson(String json) {
