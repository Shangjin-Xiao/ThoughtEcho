...
class InfoRegisterDtoMapper extends ClassMapperBase<InfoRegisterDto> {
  ...
  static InvalidType _$deviceType(InfoRegisterDto v) => v.deviceType;
  static const Field<InfoRegisterDto, InvalidType> _f$deviceType =
  ...
  static InvalidType _$protocol(InfoRegisterDto v) => v.protocol;
  static const Field<InfoRegisterDto, InvalidType> _f$protocol =
  ...
  static InfoRegisterDto fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<InfoRegisterDto>(map);
  }

  static InfoRegisterDto fromJson(String json) {
