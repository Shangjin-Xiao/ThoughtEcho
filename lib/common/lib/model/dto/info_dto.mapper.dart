...
class InfoDtoMapper extends ClassMapperBase<InfoDto> {
  ...
  static InvalidType _$deviceType(InfoDto v) => v.deviceType;
  static const Field<InfoDto, InvalidType> _f$deviceType =
  ...
  static InfoDto fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<InfoDto>(map);
  }

  static InfoDto fromJson(String json) {
