...
class ReceiveRequestResponseDtoMapper
  ...
  static InvalidType _$info(ReceiveRequestResponseDto v) => v.info;
  static const Field<ReceiveRequestResponseDto, InvalidType> _f$info =
      Field('info', _$info);
  ...
  static Map<String, InvalidType> _$files(ReceiveRequestResponseDto v) =>
      v.files;
  static const Field<ReceiveRequestResponseDto, Map<String, InvalidType>>
  ...
  static ReceiveRequestResponseDto fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ReceiveRequestResponseDto>(map);
  }

  static ReceiveRequestResponseDto fromJson(String json) {
...
abstract class ReceiveRequestResponseDtoCopyWith<
  ...
  $R call(
      {InvalidType? info, String? sessionId, Map<String, InvalidType>? files});
