...
class RegisterDtoMapper extends ClassMapperBase<RegisterDto> {
  ...
  static InvalidType _$deviceType(RegisterDto v) => v.deviceType;
  static const Field<RegisterDto, InvalidType> _f$deviceType =
  ...
  static InvalidType _$protocol(RegisterDto v) => v.protocol;
  static const Field<RegisterDto, InvalidType> _f$protocol =
  ...
  static RegisterDto fromJson(String json) {
