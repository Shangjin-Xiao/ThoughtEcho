...
class DiscoveryMethodMapper extends ClassMapperBase<DiscoveryMethod> {
  ...
  static DiscoveryMethod fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<DiscoveryMethod>(map);
  }

  static DiscoveryMethod fromJson(String json) {
...
class MulticastDiscoveryMapper extends ClassMapperBase<MulticastDiscovery> {
  ...
  static MulticastDiscovery fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<MulticastDiscovery>(map);
  }

  static MulticastDiscovery fromJson(String json) {
...
mixin MulticastDiscoveryMappable {
  ...
  MulticastDiscoveryCopyWith<MulticastDiscovery, MulticastDiscovery,
          MulticastDiscovery>
      get copyWith => _MulticastDiscoveryCopyWithImpl(
          this as MulticastDiscovery, $identity, $identity);
  @override
  String toString() {
    return MulticastDiscoveryMapper.ensureInitialized()
        .stringifyValue(this as MulticastDiscovery);
  }

  @override
  bool operator ==(Object other) {
    return MulticastDiscoveryMapper.ensureInitialized()
        .equalsValue(this as MulticastDiscovery, other);
  }

  @override
  int get hashCode {
    return MulticastDiscoveryMapper.ensureInitialized()
        .hashValue(this as MulticastDiscovery);
  }
}
...
abstract class MulticastDiscoveryCopyWith<$R, $In extends MulticastDiscovery,
    $Out> implements DiscoveryMethodCopyWith<$R, $In, $Out> {
  @override
  $R call();
...
class HttpDiscoveryMapper extends ClassMapperBase<HttpDiscovery> {
  ...
  static HttpDiscovery fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<HttpDiscovery>(map);
  }

  static HttpDiscovery fromJson(String json) {
...
mixin HttpDiscoveryMappable {
  String toJson() {
    return HttpDiscoveryMapper.ensureInitialized()
        .encodeJson<HttpDiscovery>(this as HttpDiscovery);
  }

  Map<String, dynamic> toMap() {
    return HttpDiscoveryMapper.ensureInitialized()
        .encodeMap<HttpDiscovery>(this as HttpDiscovery);
  }

  HttpDiscoveryCopyWith<HttpDiscovery, HttpDiscovery, HttpDiscovery>
      get copyWith => _HttpDiscoveryCopyWithImpl(
          this as HttpDiscovery, $identity, $identity);
  @override
  String toString() {
    return HttpDiscoveryMapper.ensureInitialized()
        .stringifyValue(this as HttpDiscovery);
  }

  @override
  bool operator ==(Object other) {
    return HttpDiscoveryMapper.ensureInitialized()
        .equalsValue(this as HttpDiscovery, other);
  }

  @override
  int get hashCode {
    return HttpDiscoveryMapper.ensureInitialized()
        .hashValue(this as HttpDiscovery);
  }
}
...
class SignalingDiscoveryMapper extends ClassMapperBase<SignalingDiscovery> {
  ...
  static const Field<SignalingDiscovery, String> _f$signalingServer =
      Field('signalingServer', _$signalingServer);
  ...
  static SignalingDiscovery fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<SignalingDiscovery>(map);
  }

  static SignalingDiscovery fromJson(String json) {
...
mixin SignalingDiscoveryMappable {
  ...
  SignalingDiscoveryCopyWith<SignalingDiscovery, SignalingDiscovery,
          SignalingDiscovery>
      get copyWith => _SignalingDiscoveryCopyWithImpl(
          this as SignalingDiscovery, $identity, $identity);
  @override
  String toString() {
    return SignalingDiscoveryMapper.ensureInitialized()
        .stringifyValue(this as SignalingDiscovery);
  }

  @override
  bool operator ==(Object other) {
    return SignalingDiscoveryMapper.ensureInitialized()
        .equalsValue(this as SignalingDiscovery, other);
  }

  @override
  int get hashCode {
    return SignalingDiscoveryMapper.ensureInitialized()
        .hashValue(this as SignalingDiscovery);
  }
}
...
abstract class SignalingDiscoveryCopyWith<$R, $In extends SignalingDiscovery,
    $Out> implements DiscoveryMethodCopyWith<$R, $In, $Out> {
  @override
...
class _SignalingDiscoveryCopyWithImpl<$R, $Out>
  ...
  late final ClassMapperBase<SignalingDiscovery> $mapper =
      SignalingDiscoveryMapper.ensureInitialized();
  @override
  $R call({String? signalingServer}) => $apply(FieldCopyWithData(
...
class DeviceMapper extends ClassMapperBase<Device> {
  ...
  static const Field<Device, String> _f$signalingId =
      Field('signalingId', _$signalingId);
  ...
  static Set<DiscoveryMethod> _$discoveryMethods(Device v) =>
      v.discoveryMethods;
  static const Field<Device, Set<DiscoveryMethod>> _f$discoveryMethods =
      Field('discoveryMethods', _$discoveryMethods);
...
class _DeviceCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Device, $Out>
  ...
  Device $make(CopyWithData data) => Device(
      ...
      discoveryMethods:
          data.get(#discoveryMethods, or: $value.discoveryMethods));
