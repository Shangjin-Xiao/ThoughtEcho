...
class _SlidingCardState extends State<SlidingCard>
  ...
  Widget build(BuildContext context) {
    ...
    // 根据屏幕高度动态调整**内**边距（字离卡片边多远）。
    //
    // 外边距（卡片离屏幕边多远）不在这里：它曾经和内边距共用这一个值，
    // 于是「卡片多大」和「字多松」被同一个数字管着——想让卡片占满一点，
    // 就只能把正文挤到边上。首页那张一言卡因此比它下面的「今日思考」窄了
    // 一整圈（26 对 12），两张卡的左边缘对不齐，上面那张看着缩水。
    // 现在外边距归调用方，见 `DailyQuoteView`。
