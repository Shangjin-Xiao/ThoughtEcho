        ...
        .listen(
          (list) async {
            try {
              ...
              await QuoteContent.prewarmDocumentsInIsolate(
                list,
                prioritizeBoldContent: settings.prioritizeBoldContentInCollapse,
              );
            } catch (e) {
              logDebug('Isolate prewarm failed: $e', source: 'NoteListView');
            }
            ...
            if (mounted) {
              ...
              if (isFirstLoad) {
                ...
                QuoteContent.prewarmCollapsedContentCache(
                  list,
                  prioritizeBoldContent:
                      settings.prioritizeBoldContentInCollapse,
                );
