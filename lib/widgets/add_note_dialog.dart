...
class _AddNoteDialogState extends State<AddNoteDialog> {
        ...
        if (widget.initialQuote == null) {
          ...
          if (settingsService != null) {
            ...
            if (autoLocation || autoWeather) {
              ...
              if (autoLocation) {
                await _fetchLocationWeatherForNewNote(
                  includeWeather: autoWeather,
                );
              } else if (autoWeather) {
                // 没有勾选位置但勾选了天气，尝试获取天气
  ...
  /// 获取新建笔记的实时位置和天气
  Future<void> _fetchLocationWeatherForNewNote({
                              ...
                              FilterChip(
                                ...
                                onSelected: (value) async {
                                  ...
                                  if (value &&
                                      _newLocation == null &&
                                      _newLatitude == null) {
                                    _fetchLocationWeatherForNewNote(
