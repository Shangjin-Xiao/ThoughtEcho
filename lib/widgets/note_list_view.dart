...
class _NoteListViewState extends State<NoteListView> {
  ...
  Widget _buildNoteList(DatabaseService db, ThemeData theme) {
    return FutureBuilder<List<Quote>>(
      future: db.getUserQuotes(tagIds: widget.selectedTagIds.isNotEmpty ? widget.selectedTagIds : null),
      builder: (context, snapshot) {
        ...
        if (widget.searchQuery.isNotEmpty) {
          quotes = quotes.where((quote) =>
              quote.content.toLowerCase().contains(widget.searchQuery.toLowerCase()) ||
              (quote.source != null && quote.source!.toLowerCase().contains(widget.searchQuery.toLowerCase()))).toList();
        }
          ...
          child: Column(
            ...
            children: [
              ...
              RadioListTile<String>(
                ...
                subtitle: Text(widget.sortAscending ? '升序 A-Z' : '降序 Z-A'),
                value: 'name',
                groupValue: widget.sortType,
                onChanged: (value) {
                  setModalState(() {
