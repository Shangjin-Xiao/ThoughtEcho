...
class SendingFileMapper extends ClassMapperBase<SendingFile> {
  ...
  static InvalidType _$file(SendingFile v) => v.file;
  static const Field<SendingFile, InvalidType> _f$file = Field('file', _$file);
  static InvalidType _$status(SendingFile v) => v.status;
  static const Field<SendingFile, InvalidType> _f$status =
