...
class SendSessionStateMapper extends ClassMapperBase<SendSessionState> {
  ...
  static InvalidType _$status(SendSessionState v) => v.status;
  static const Field<SendSessionState, InvalidType> _f$status =
      Field('status', _$status);
  static InvalidType _$target(SendSessionState v) => v.target;
  static const Field<SendSessionState, InvalidType> _f$target =
      Field('target', _$target);
  static Map<String, InvalidType> _$files(SendSessionState v) => v.files;
  static const Field<SendSessionState, Map<String, InvalidType>> _f$files =
      Field('files', _$files);
