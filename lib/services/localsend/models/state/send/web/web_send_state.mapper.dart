...
class WebSendStateMapper extends ClassMapperBase<WebSendState> {
  ...
  static Map<String, InvalidType> _$sessions(WebSendState v) => v.sessions;
  static const Field<WebSendState, Map<String, InvalidType>> _f$sessions =
      Field('sessions', _$sessions);
  static Map<String, InvalidType> _$files(WebSendState v) => v.files;
  static const Field<WebSendState, Map<String, InvalidType>> _f$files =
      Field('files', _$files);
...
class _WebSendStateCopyWithImpl<$R, $Out>
  ...
  MapCopyWith<$R, String, InvalidType,
      ...
      get sessions => MapCopyWith($value.sessions,
          (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(sessions: v));
  @override
  MapCopyWith<$R, String, InvalidType,
          ObjectCopyWith<$R, InvalidType, InvalidType>>
