...
class WebSendFileMapper extends ClassMapperBase<WebSendFile> {
  ...
  static InvalidType _$file(WebSendFile v) => v.file;
  static const Field<WebSendFile, InvalidType> _f$file = Field('file', _$file);
...
abstract class WebSendFileCopyWith<$R, $In extends WebSendFile, $Out>
  ...
  $R call(
      {InvalidType? file, AssetEntity? asset, String? path, List<int>? bytes});
