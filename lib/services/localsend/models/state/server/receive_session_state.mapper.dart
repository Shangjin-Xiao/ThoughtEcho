...
class ReceiveSessionStateMapper extends ClassMapperBase<ReceiveSessionState> {
  ...
  static InvalidType _$status(ReceiveSessionState v) => v.status;
  static const Field<ReceiveSessionState, InvalidType> _f$status =
      Field('status', _$status);
  static InvalidType _$sender(ReceiveSessionState v) => v.sender;
  static const Field<ReceiveSessionState, InvalidType> _f$sender =
  ...
  static Map<String, InvalidType> _$files(ReceiveSessionState v) => v.files;
  static const Field<ReceiveSessionState, Map<String, InvalidType>> _f$files =
      Field('files', _$files);
