...
class ServerStateMapper extends ClassMapperBase<ServerState> {
  ...
  static InvalidType _$httpServer(ServerState v) => v.httpServer;
  static const Field<ServerState, InvalidType> _f$httpServer =
  ...
  static InvalidType _$session(ServerState v) => v.session;
  static const Field<ServerState, InvalidType> _f$session =
      Field('session', _$session);
  static InvalidType _$webSendState(ServerState v) => v.webSendState;
  static const Field<ServerState, InvalidType> _f$webSendState =
...
abstract class ServerStateCopyWith<$R, $In extends ServerState, $Out>
  ...
  $R call(
      {InvalidType? httpServer,
      String? alias,
      int? port,
      bool? https,
      InvalidType? session,
      InvalidType? webSendState,
...
class _ServerStateCopyWithImpl<$R, $Out>
  ...
  $R call(
      ...
      $apply(FieldCopyWithData({
        ...
        if (webSendState != null) #webSendState: webSendState,
