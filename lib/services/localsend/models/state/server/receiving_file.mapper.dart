...
class ReceivingFileMapper extends ClassMapperBase<ReceivingFile> {
  ...
  static InvalidType _$file(ReceivingFile v) => v.file;
  static const Field<ReceivingFile, InvalidType> _f$file =
      Field('file', _$file);
  static InvalidType _$status(ReceivingFile v) => v.status;
  static const Field<ReceivingFile, InvalidType> _f$status =
