...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static const Field<SettingsState, ThemeMode> _f$theme =
      Field('theme', _$theme);
  static InvalidType _$colorMode(SettingsState v) => v.colorMode;
  static const Field<SettingsState, InvalidType> _f$colorMode =
      Field('colorMode', _$colorMode);
  static InvalidType _$locale(SettingsState v) => v.locale;
  static const Field<SettingsState, InvalidType> _f$locale =
  ...
  static InvalidType _$sendMode(SettingsState v) => v.sendMode;
  static const Field<SettingsState, InvalidType> _f$sendMode =
  ...
  static InvalidType _$deviceType(SettingsState v) => v.deviceType;
  static const Field<SettingsState, InvalidType> _f$deviceType =
