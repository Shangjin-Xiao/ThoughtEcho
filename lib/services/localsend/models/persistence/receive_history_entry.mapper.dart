...
class ReceiveHistoryEntryMapper extends ClassMapperBase<ReceiveHistoryEntry> {
  ...
  static InvalidType _$fileType(ReceiveHistoryEntry v) => v.fileType;
  static const Field<ReceiveHistoryEntry, InvalidType> _f$fileType =
  ...
  static ReceiveHistoryEntry fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ReceiveHistoryEntry>(map);
  }

  static ReceiveHistoryEntry fromJson(String json) {
