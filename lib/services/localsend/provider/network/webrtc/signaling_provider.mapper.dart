...
class SignalingStateMapper extends ClassMapperBase<SignalingState> {
  ...
  static Map<String, InvalidType> _$connections(SignalingState v) =>
      v.connections;
  static const Field<SignalingState, Map<String, InvalidType>> _f$connections =
  ...
  static SignalingState fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<SignalingState>(map);
  }

  static SignalingState fromJson(String json) {
...
abstract class SignalingStateCopyWith<$R, $In extends SignalingState, $Out>
  ...
  MapCopyWith<$R, String, InvalidType,
      ObjectCopyWith<$R, InvalidType, InvalidType>> get connections;
  $R call(
      {List<String>? signalingServers,
      List<String>? stunServers,
      Map<String, InvalidType>? connections});
